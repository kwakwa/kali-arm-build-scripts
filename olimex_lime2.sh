...
extras="iceweasel xfce4-terminal wpasupplicant dnsutils"
...
dd if=/dev/zero of=${basedir}/kali-$1-olimex_lime2.img bs=1M count=7000
parted kali-$1-olimex_lime2.img --script -- mklabel msdos
parted kali-$1-olimex_lime2.img --script -- mkpart primary fat32 2048s 264191s
parted kali-$1-olimex_lime2.img --script -- mkpart primary ext4 264192s 100%

# Set the partition variables
loopdevice=`losetup -f --show ${basedir}/kali-$1-olimex_lime2.img`
...
# soon.
echo "Generating sha1sum of kali-$1-olimex_lime2.img"
sha1sum kali-$1-olimex_lime2.img > ${basedir}/kali-$1-olimex_lime2.img.sha1sum
# Don't pixz on 32bit, there isn't enough memory to compress the images.
MACHINE_TYPE=`uname -m`
if [ ${MACHINE_TYPE} == 'x86_64_disabled' ]; then
echo "Compressing kali-$1-olimex_lime2.img"
pixz ${basedir}/kali-$1-olimex_lime2.img ${basedir}/kali-$1-olimex_lime2.img.xz
rm ${basedir}/kali-$1-olimex_lime2.img
echo "Generating sha1sum of kali-$1-olimex_lime2.img.xz"
sha1sum kali-$1-olimex_lime2.img.xz > ${basedir}/kali-$1-olimex_lime2.img.xz.sha1sum
fi
